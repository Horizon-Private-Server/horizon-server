...
namespace Deadlocked.Server.SCERT
{
    public class ScertLengthFieldBasedFrameDecoder : ByteToMessageDecoder
    {
        ...
        public ScertLengthFieldBasedFrameDecoder(int maxFrameLength, int lengthFieldOffset, int lengthFieldLength)
        ...
        public ScertLengthFieldBasedFrameDecoder(int maxFrameLength, int lengthFieldOffset, int lengthFieldLength, int lengthAdjustment, int initialBytesToStrip)
        ...
        /// </param>
        public ScertLengthFieldBasedFrameDecoder(int maxFrameLength, int lengthFieldOffset, int lengthFieldLength, int lengthAdjustment, int initialBytesToStrip, bool failFast)
        ...
        ///     Defaults to <c>true</c> in other overloads.
        /// </param>
        public ScertLengthFieldBasedFrameDecoder(ByteOrder byteOrder, int maxFrameLength, int lengthFieldOffset, int lengthFieldLength, int lengthAdjustment, int initialBytesToStrip, bool failFast)
        {
            if (maxFrameLength <= 0)
            {
