...
{
    [MediusApp(MediusAppPacketIds.MediusServerReport)]
    public class MediusServerReport : BaseAppMessage
    {

        public override MediusAppPacketIds Id => MediusAppPacketIds.MediusServerReport;
