...
{
    [MediusApp(MediusAppPacketIds.MediusServerSetAttributesResponse)]
    public class MediusServerSetAttributesResponse : BaseMGCLMessage
    {

        public override MediusAppPacketIds Id => MediusAppPacketIds.MediusServerSetAttributesResponse;
