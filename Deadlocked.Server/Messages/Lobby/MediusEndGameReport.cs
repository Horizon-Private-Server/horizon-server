...
{
    [MediusApp(MediusAppPacketIds.EndGameReport)]
    public class MediusEndGameReport : BaseAppMessage
    {

        public override MediusAppPacketIds Id => MediusAppPacketIds.EndGameReport;
