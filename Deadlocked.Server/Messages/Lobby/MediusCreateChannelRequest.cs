...
{
    [MediusApp(MediusAppPacketIds.CreateChannel)]
    public class MediusCreateChannelRequest : BaseLobbyMessage
    {

        public override MediusAppPacketIds Id => MediusAppPacketIds.CreateChannel;
