...
namespace Server.Medius.Config
{
    public class AppSettings
    {
        ...
        /// </summary>
        public bool CreateAccountOnNotFound { get; private set; } = false;
        ...
        /// <summary>
        /// When true, will enable medius file services.
        /// </summary>
        public bool EnableMediusFileServices { get; private set; } = false;
